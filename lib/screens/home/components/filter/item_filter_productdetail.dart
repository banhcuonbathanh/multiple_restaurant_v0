...
import '../product_detail_modal_sheet_home/product_detail_list_home.dart';

class ItemFilterProductDetail extends HookConsumerWidget {
  const ItemFilterProductDetail({
    Key? key,
    required this.filterProducts,
    required this.title,
  }) : super(key: key);

  final ValueNotifier<List<ProductDetailModel>> filterProducts;
  final String title;
  @override
                      ...
                      child: InkWell(
                        ...
                        child: Row(
                          children: [
                            ClipRRect(
                              borderRadius: BorderRadius.circular(15),
                              child: Image.network(product.productdetaiImage!),
                            ),
                            Spacer(),
                            Text(product.productdetaitName!,
