...
class RowCategoryNoInformation extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    // if (restaurantsUserIdData!.restaurantCategory != null &&
    //     categoryIndex.value == '') {
    //   categoryIndex.value = restaurantsUserIdData.restaurantCategory!;
    // }
