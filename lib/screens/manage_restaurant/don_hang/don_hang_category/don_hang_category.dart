...
class CategoryDonHang extends HookConsumerWidget {
  final Function funcIsShowWaitingConfirm;
  final Function funcIsShowConfirm;
  final Function funcIsCompleted;
  final Function funcIsShowCalceled;
  const CategoryDonHang({
    required this.funcIsShowCalceled,
    required this.funcIsShowWaitingConfirm,
    required this.funcIsShowConfirm,
    required this.funcIsCompleted,
    Key? key,
  }) : super(key: key);
      ...
      child: Row(
        children: [
          ...
          Expanded(
            ...
            child: CustomerButton(
              fontSize: 12,
              backgoundColor: tapIndex.value == 3 ? null : Colors.grey.shade200,
              BorderRadiuscircular: 8,
              buttonHeight: 45,
              buttonWidth: 110,
              press: () async {
