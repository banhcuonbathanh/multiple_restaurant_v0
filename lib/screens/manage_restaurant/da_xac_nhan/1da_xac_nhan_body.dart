...
class DaXacNhanBodyamnagerRestaurant extends HookConsumerWidget {
  static String routeName = "/DaXacNhanBodyamnagerRestaurant";
  const DaXacNhanBodyamnagerRestaurant({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      appBar: AppBar(
        title:
            Text('Đơn Hàng Đã Xác Nhận', style: TextStyle(color: Colors.black)),
      ),
      body: SafeArea(
